...
/*   Updated: 2025/02/13 11:58:21 by malde-ch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void init_builtins(t_builtin *builtins)
{
	...
	builtins[3].func = NULL;
/*     builtins[1].name = "cd";
    builtins[1].func = builtin_cd;
    builtins[2].name = "echo";
    builtins[2].func = builtin_echo;
...
builtin_func get_builtin_func(const char *name, t_builtin *builtins)
{
    ...
    {
        if (ft_strncmp(name, builtins[i].name, ft_strlen(name)) == 0 && ft_strlen(name) == ft_strlen(builtins[i].name))
        {
